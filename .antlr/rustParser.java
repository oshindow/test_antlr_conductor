...
public class rustParser extends Parser {
	...
	public static final int
		...
		T__17=18, T__18=19, T__19=20, MUT=21, STRING=22, BOOL=23, IDENTIFIER=24, 
		NUMBER=25, WS=26, LPAREN=27, RPAREN=28;
	public static final int
	...
	private static String[] makeLiteralNames() {
		return new String[] {
			...
			"'..'", "'loop'", "'break'", "'{'", "'}'", "'struct'", "'*'", "'/'", 
			"'+'", "'-'", "'.'", "'bool'", "'mut'", null, null, null, null, null, 
			"'('", "')'"
		};
	}
	...
	private static String[] makeSymbolicNames() {
		return new String[] {
			...
			null, null, null, null, null, null, null, null, null, "MUT", "STRING", 
			"BOOL", "IDENTIFIER", "NUMBER", "WS", "LPAREN", "RPAREN"
		};
	}
	...
	public final StartContext start() throws RecognitionException {
		...
		try {
			...
			do {
				...
				_errHandler.sync(this);
				_la = _input.LA(1);
			} while ( (((_la) & ~0x3f) == 0 && ((1L << _la) & 197156018L) != 0) );
			setState(45);
			match(EOF);
			}
		}
	...
	public final BlockContext block() throws RecognitionException {
		...
		try {
			...
			_errHandler.sync(this);
			_la = _input.LA(1);
			if ((((_la) & ~0x3f) == 0 && ((1L << _la) & 197136384L) != 0)) {
				{
				setState(118);
				expression(0);
				}
